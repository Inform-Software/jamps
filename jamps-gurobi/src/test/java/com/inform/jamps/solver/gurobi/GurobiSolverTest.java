...
import com.inform.jamps.solver.gurobi.GurobiSolver;
...
public class GurobiSolverTest {
  ...
  protected GurobiProgram createProgram (GRBModel grbModel) throws Exception {
    ...
    when (grbModel.addConstrs (any (GRBLinExpr[].class), any (char[].class), any (double[].class), any (String[].class))).thenReturn (new GRBConstr[] {mock (GRBConstr.class)});
