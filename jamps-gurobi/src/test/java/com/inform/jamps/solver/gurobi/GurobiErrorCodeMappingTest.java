...
import com.inform.jamps.solver.gurobi.GurobiErrorCodeMapping;
...
public class GurobiErrorCodeMappingTest {
  ...
  public void testClassIsWellDefined () throws SecurityException,
    ...
    for (Field field: fields) {
      ...
      if (!Modifier.isFinal (field.getModifiers ()) && field.getDeclaringClass ().equals (GurobiErrorCodeMapping.class)) {
